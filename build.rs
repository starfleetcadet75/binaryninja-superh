...
// Check last run location for path to Binary Ninja.
// Otherwise check the default install locations.
...
fn main() {
    // Use BINARYNINJADIR first for custom BN builds/configurations (BN devs/build server),
